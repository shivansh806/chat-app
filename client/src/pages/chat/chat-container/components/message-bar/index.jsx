...
const messageBar = () => {
  ...
  return (
    <div className='h-[10vw] bg-[#1c1d25] flex justify-center items-center px-8 mb-6 gap-6'>
      ...
      <div className="absoulte bottom-16 right-0" ref={emojiRef}>
          ...
          />
           ...
           <button className='bg-[#8417ff] rounded-md flex items-center justify-center p-5 hover:bg-[#741bda] 
           focus:bg-[#741bda] focus:border-none focus:outline-none focus:text-white transition-all duration-300'
